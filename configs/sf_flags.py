...
tf.app.flags.DEFINE_integer('nb_steps_sf', 200000, """Number of steps to run fitted successor features learning""")
...
tf.app.flags.DEFINE_float('lr', 0.1, """Learning rate value""")
...
tf.app.flags.DEFINE_string('matrix_type', "sf", """The type of matrix to generate goals from""")
