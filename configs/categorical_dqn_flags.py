...
tf.app.flags.DEFINE_integer('agent_history_length', 2, """Number of frames that makes every state""")
...
tf.app.flags.DEFINE_integer('update_freq', 2, """Frequency of training updates""")
