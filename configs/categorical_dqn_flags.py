...
tf.app.flags.DEFINE_integer('gradient_norm_clipping', 50, """Value to clip the gradient norm""")
...
tf.app.flags.DEFINE_integer('observation_steps', 96,
                            """Number of steps to add entries in the experience replay before starting training""")
tf.app.flags.DEFINE_integer('max_total_steps', 1000000, """Total number of steps to use for training""")
